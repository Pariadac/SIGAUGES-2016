...
//Test rutes
    ...
    Route::get('institucion','InstitucionController@index');
    Route::post('institucion/registerform','InstitucionController@renderform');
    Route::post('institucion/buscar','InstitucionController@renderform');
    Route::post('institucion/crear','InstitucionController@ajaxRegularStore');
    Route::post('institucion/modificar/{id}','InstitucionController@ajaxRegularUpdate');
    Route::post('institucion/eliminar/{id}','InstitucionController@ajaxRegularDestroy');
