        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    ...
                    {{Form::text('direccion_inst',null,['class'=>'form-control camporequerido','type'=>'text', 'data-etiqueta'=>'2'])}}
                </div>
               
                <div class="col-md-6">
                    {{Form::label('correo_inst','Correo de la institucion*',['id'=>"etiquetarequerida-3"])}}
                    {{Form::text('correo_inst',null,['class'=>'form-control camporequerido solomails','type'=>'text', 'data-etiqueta'=>'3'])}}
                </div>

                <div class="col-md-6">
                    {{Form::label('telefono_inst','Telefono de la institucion*',['id'=>"etiquetarequerida-4"])}}
                    {{Form::text('telefono_inst',null,['class'=>'form-control camporequerido solo-numero solomaximo','type'=>'text', 'data-max'=>'12', 'data-etiqueta'=>'4'])}}
                </div>         
