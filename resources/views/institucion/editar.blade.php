    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-6">
                ...
                {{Form::text('correo_inst',$institucion->correo_institucional,['class'=>'form-control camporequerido solomails','type'=>'text', 'data-etiqueta'=>'3'])}}
            </div>
           
            <div class="col-md-6">
                {{Form::label('telefono_inst','Telefono de la institucion*',['id'=>"etiquetarequerida-4"])}}
                {{Form::text('telefono_inst',$institucion->telefono_institucion,['class'=>'form-control camporequerido solo-numero solomaximo','type'=>'text', 'data-max'=>'11', 'data-etiqueta'=>'4'])}}
            </div>
